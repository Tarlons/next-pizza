...
export const Filters: React.FC<Props> = ({ className }) => {
	...
	const sortFunction = (a: { value: string }, b: { value: string }) => {
		const isSelectedA = filters.selectedIngredients.has(a.value)
		const isSelectedB = filters.selectedIngredients.has(b.value)
	...
	return (
		<div className={className}>
			...
			<CheckboxFiltersGroup
				...
				sortFunction={sortFunction} // Передача функции сортировки
			/>
		</div>
	)
}
